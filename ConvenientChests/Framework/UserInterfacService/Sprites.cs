...
internal static class Sprites
{
    public static readonly NineSlice TabBackground = new()
    {
        ...
        Top = new TextureRegion(Game1.mouseCursors, new Rectangle(4, 384, 1, 3), true),
    ...
    public static readonly TextureRegion LeftArrow = new(Game1.mouseCursors, new Rectangle(8, 268, 44, 40));

    public static readonly TextureRegion RightArrow = new(Game1.mouseCursors, new Rectangle(12, 204, 44, 40));

    public static readonly TextureRegion DownArrow = new(Game1.mouseCursors, new Rectangle(0, 64, 64, 64));

    public static readonly TextureRegion UpArrow = new(Game1.mouseCursors, new Rectangle(64, 64, 64, 64));

    public static readonly TextureRegion EmptyCheckbox = new(Game1.mouseCursors, new Rectangle(227, 425, 9, 9), true);

    public static readonly TextureRegion FilledCheckbox = new(Game1.mouseCursors, new Rectangle(236, 425, 9, 9), true);

    public static readonly TextureRegion ExitButton = new(Game1.mouseCursors, new Rectangle(337, 494, 12, 12), true);

    public static void Draw(this SpriteBatch batch, Texture2D sheet, Rectangle sprite, int x, int y, int width,
        int height, Color? color = null)
    {
        batch.Draw(sheet, new Rectangle(x, y, width, height), sprite, color ?? Color.White);
    }

    public static void Draw(this SpriteBatch batch, TextureRegion textureRegion, int x, int y, int width,
        int height, Color? color = null)
    {
