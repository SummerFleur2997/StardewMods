...
// <source>https://github.com/Pathoschild/StardewMods/blob/develop/Common/UI/BaseOverlay.cs</source> 
...
namespace ConvenientChests.Framework.CategorizeChests.Interface {
    ...
    internal abstract class BaseOverlay : IDisposable {
        ...
        protected BaseOverlay(IModEvents events, IInputHelper inputHelper, IReflectionHelper reflection,
            ...
            this.LastViewport = new Rectangle(Game1.uiViewport.X, Game1.uiViewport.Y, Game1.uiViewport.Width,
        ...
        protected void DrawCursor() {
            ...
            if (Constants.TargetPlatform == GamePlatform.Android)
                cursorPos *= Game1.options.zoomLevel /
                             this.Reflection.GetProperty<float>(typeof(Game1), "NativeZoomLevel").GetValue();
        ...
        private void OnButtonPressed(object? sender, ButtonPressedEventArgs e) {
            ...
            if (Constants.TargetPlatform == GamePlatform.Android) {
                ...
                handled = this.ReceiveLeftClick((int)(Game1.getMouseX() * Game1.options.zoomLevel / nativeZoomLevel),
